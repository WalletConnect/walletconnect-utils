...
import { IdentityKeyClaims, JwtHeader } from "./types";
...
export const encodeJwt = (header: JwtHeader, payload: IdentityKeyClaims, signature: Uint8Array) => {
...
export const encodeData = (header: JwtHeader, payload: IdentityKeyClaims) => {
