...
import { formatChildLoggerContext, getDefaultLoggerOptions, generateChildLogger, generateServerLogger } from "../src";
...
describe("Logger", () => {
  ...
  describe("Chunk logging", () => {
	...
	const maxTestByteSize = (BASE_LOG_SIZE + TEST_MESSAGE_SIZE) * 4;
        const { logger, chunkLoggerController }  = generateServerLogger({maxSizeInBytes: maxTestByteSize});
