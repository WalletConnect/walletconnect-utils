...
export abstract class IAsyncStorage<K = string, V = any> {
  ...
  public abstract getItem(k: K, cb?: AsyncStorageTypes.ErrBack<V>): Promise<V | null>;

  public abstract setItem(k: K, v: V, cb?: AsyncStorageTypes.ErrBack<V>): Promise<void>;

  public abstract removeItem(k: K, cb?: AsyncStorageTypes.ErrBack<V>): Promise<void>;

  public abstract clear(cb?: AsyncStorageTypes.ErrBack<V>): Promise<void>;

  public abstract getAllKeys(cb?: AsyncStorageTypes.ErrBack<Array<K>>): Promise<Array<K>>;
  ...
  public abstract multiRemove(keys: Array<K>, cb?: AsyncStorageTypes.ErrBack<V>): Promise<void>;
